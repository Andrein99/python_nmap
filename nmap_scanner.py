...
def priorizar_hosts(network_data):
    ...
    chat_completion = client.chat.completions.create(
        messages=[
            ...
            {"role": "user", "content": f"Teniendo en cuenta el siguiente descubrimiento de hosts, puertos y servicios, ordena los hosts de más vulnerable a menos vulnerable y propon los siguientes pasos para la fase de explotación en un ejercicio de hacking ético.\n\n{network_data}"}
        ],
...
if (__name__ == '__main__'):
    ...
    network_data = services_scan('192.168.52.0/24')
